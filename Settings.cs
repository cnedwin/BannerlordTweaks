...
namespace BannerlordTweaks
{
        ...
        public override string DisplayName => new TextObject("综合设置1.5.6.2 (cnedwin)", new Dictionary<string, TextObject>
    {
        ...
        [SettingPropertyBool("Enable Character Fertility Probability Tweak", Order = 1, RequireRestart = false, HintText = "Allows for adjusting for the probability to get pregnant, this will apply to everyone.", IsToggle = true), SettingPropertyGroup("生育调整/Fertility Probability Tweak")]
        public bool CharacterFertilityProbabilityTweakEnabled { get; set; } = false;
                
        [SettingPropertyFloatingInteger("Character Fertility Probability", 0f, 1.0f, HintText = "Native value is 0.95. Determines the chance of getting pregnant"), SettingPropertyGroup("生育调整/Fertility Probability Tweak")]
