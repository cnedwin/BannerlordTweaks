 ...
 * 
 * Bug: Disbanding the army != working. You can click on the party leaders in the army and 
...
namespace BannerlordTweaks.Patches
{
	...
	public class MapVMPatch
	{
		...
		static bool Prepare()
		{
			return false; // BannerlordTweaksSettings.Instance.GatherArmyTweakEnabled;
		}
	}
