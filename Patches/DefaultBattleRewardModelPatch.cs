...
//                var stat = new ExplainedNumber((renownValueOfBattle * contributionShare) * battleRenownMultiplier);
...
//                __result.Add(stat.BaseNumber,null,null);
//                patched = true;
//            }
//            catch (Exception ex)
//            {
...
//                var stat = new ExplainedNumber(party.MapFaction.IsKingdomFaction ? (influenceValueOfBattle * contributionShare * battleInfluenceMultiplier) : 0f);
